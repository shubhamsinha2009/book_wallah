...
List<Book> sd = [
  ...
  Book(
    ...
    chapters: [
      Chapter(
          chapterName: "Crystal Properties and Growth of Semiconductors",
          links: [
            Linkurl(
                number: 1, link: "1tvNvtokWLQH_Fx5Yzq1famsWtMJk-3Sh".gdrive),
            // Link(number: 2, link: "62efb3a3ebd48h".uploadgram),
          ]),
      Chapter(chapterName: "Atoms and Electrons", links: [
        Linkurl(number: 1, link: "1XePea4cgPLA2NcwtfKevIhQuSRBavjLX".gdrive),
        // Link(number: 2, link: "62efb3a45d5edh".uploadgram),
      ]),
      Chapter(
          chapterName: "Energy Bands and Charge Carriers in Semiconductors",
          links: [
            Linkurl(
                number: 1, link: "11XkbU7LcU42L7mo-KY7Fc-r-kq6bxCQu".gdrive),
            //Link(number: 2, link: "62efb3a4a8f21h".uploadgram),
          ]),
      Chapter(chapterName: "Excess Carriers in Semiconductors", links: [
        Linkurl(number: 1, link: "1bacj8mo7-J9sxJXttEulqXSlktP_6bSH".gdrive),
        //Link(number: 2, link: "62efb3a501461h".uploadgram),
      ]),
      Chapter(chapterName: "Junctions", links: [
        Linkurl(number: 1, link: "1EqtwmL6-J3FvemRnbMorldQplc-o-10n".gdrive),
        //Link(number: 2, link: "62efb3a550400h".uploadgram),
      ]),
      Chapter(chapterName: "Field-Effect Transistors", links: [
        Linkurl(number: 1, link: "12F7EO0aIcSAf6nyal9ZPHzyqNIyydn7Y".gdrive),
        //Link(number: 2, link: "62efb3a599e9fh".uploadgram),
      ]),
      Chapter(chapterName: "Bipolar Junction Transistors", links: [
        Linkurl(number: 1, link: "1LCN-noEy_6kRpKYsQETV0kY9bqU6ZCDL".gdrive),
        //Link(number: 2, link: "62efb3a9eec64h".uploadgram),
      ]),
      Chapter(chapterName: "Optoelectronic Devices", links: [
        Linkurl(number: 1, link: "16-P1L_J1QRvgTswZ_tbjSKJH7Q5LwSI9".gdrive),
        //  Link(number: 2, link: "62efb3aa410cch".uploadgram),
      ]),
      Chapter(
        chapterName: "Integrated Circuits",
        links: [
          Linkurl(number: 1, link: "1KyN6FUjtukhVt5j2s_uJdBaJuo1XkwKd".gdrive),
          //Link(number: 2, link: "62efb3aa8970dh".uploadgram),
        ],
      ),
      Chapter(
          chapterName: "High-Frequency, High-Power and Nanoelectronic Devices",
          links: [
            Linkurl(
                number: 1, link: "1aPWwEYDIT9O2i37mUTbTFudzP30bGCdR".gdrive),
            // Link(number: 2, link: "62efb3aad352ah".uploadgram),
          ]),
    ],
  ),
